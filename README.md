...
**What it logs:** The interface captures keystroke, cursor, and navigation events across all panels, enabling analysis of how participants move between reading, using the LLM, and writing throughout the task. These logs yield behavioral metrics at different granularities: [critical-thinking-data-dictionary](https://github.com/xxxxbrandieeee/critical-thinking-data-dictionary).
